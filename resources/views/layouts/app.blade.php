...
.footer-text {
    ...
    margin: 10px 0; /* Space above and below the social media links */
}
...
.card {
    ...
    align-items: center; /* Center align the card content */
}
...
.card-img-top {
    ...
    margin-top: 15px; /* Add some margin to separate from the card edges */
}
